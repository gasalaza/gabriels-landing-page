...
- **LinkedIn-launch frontend pipeline (2026-07-10):** Shipped PR #41 SEO/Open Graph/Twitter metadata, canonical, JSON-LD Person, favicon/webmanifest, robots.txt, sitemap.xml, OG image assets, reduced-motion/focus-visible, and preload improvements (Neo 🟢). Shipped PR #42 Built Secure section + responsible-disclosure note, then softened absolute security wording per Rai's 4 edits (Rai 🟡 adopted).
